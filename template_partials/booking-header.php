        ...
        <div class="opac py-5">
            ...
            <div class="container">
                <div class="bg-purple rounded-xl border-main d-flex flex-column flex-md-row">
                    <div class="booking-value-prop-img w-100"><img class="book-img" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dark/booking-skateboards-cropped.jpg" alt=""></div>
