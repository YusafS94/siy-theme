<nav class="navbar navbar-expand-lg navbar-dark bg-light container rounded-lg border-alt my-4">
  ...
  <div class="collapse navbar-collapse d-flex flex-column flex-lg-row justify-content-center" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 w-100 d-flex justify-content-around align-items-center">
      ...
      <!-- <li class="nav-item skateboard nav-button d-flex justify-content-center align-items-center">
	    ...
	    <li class="nav-item skateboard nav-button d-flex justify-content-center align-items-center">
        <a class="nav-link text-light title-nav" href="/contact">Contact</a>
      </li>
      <li class="nav-item skateboard nav-button d-flex justify-content-center align-items-center">
        <a class="nav-link text-light disabled title-nav" href="/shop">Shop</a>
      </li>
    </ul>
