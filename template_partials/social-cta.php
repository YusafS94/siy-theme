...
<section class="yellow-doodles-bg">
        <div class="py-5 text-center opac">
            ...
            <div class="d-flex justify-content-center">
                ...
                <a class="social-icons" target="_blank" href="https://www.tiktok.com/@skateityourself"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dark/TIK-TOK-YELLOW-2.svg" alt="Tiktok"></a>
            </div>
        </div>
    </section>